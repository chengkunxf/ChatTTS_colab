...
BASE_URL = "https://1beb34e9690145f279.gradio.live/"
...
def convert_to_accessible_url(remote_path):
    ...
    accessible_url = BASE_URL + "/file=" + accessible_path
...
def generate_tts_audio_stream_with_gradio_client():
    ...
    result = client.predict(
        ...
        pt_file=None,
        stream_mode="fake",
        api_name="/generate_tts_audio_stream"
    )
    ...
    # 下载文件并保存到本地
    local_file_path = "output_stream.wav"
...
# 调用函数生成 TTS 音频
generate_tts_audio_stream_with_gradio_client()
